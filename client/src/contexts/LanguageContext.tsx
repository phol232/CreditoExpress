...
const translations: Translations = {
  ...
  // Login Modal
  'login.title': { es: '¡Bienvenido de nuevo!', en: 'Welcome back!' },
  'login.subtitle': { es: 'Ingresa para obtener acceso ilimitado a datos e información.', en: 'Enter to get unlimited access to data & information.' },
  'login.email': { es: 'Email', en: 'Email' },
  'login.password': { es: 'Contraseña', en: 'Password' },
  'login.remember_me': { es: 'Recordarme', en: 'Remember me' },
  'login.forgot_password': { es: '¿Olvidaste tu contraseña?', en: 'Forgot your password?' },
  'login.sign_in': { es: 'Iniciar Sesión', en: 'Log In' },
  'login.no_account': { es: '¿No tienes una cuenta?', en: "Don't have an account?" },
  'login.register_here': { es: 'Regístrate aquí', en: 'Register here' },
  'login.or': { es: 'O, Inicia sesión con', en: 'Or, Login with' },
  'login.google': { es: 'Iniciar sesión con Google', en: 'Sign up with Google' },
  'login.github': { es: 'Iniciar sesión con GitHub', en: 'Sign up with GitHub' },
  
  // Register Modal
  'register.title': { es: '¡Crea tu cuenta!', en: 'Create your account!' },
  'register.subtitle': { es: 'Únete para obtener acceso ilimitado a nuestros servicios financieros.', en: 'Join to get unlimited access to our financial services.' },
  ...
  'register.confirm_password': { es: 'Confirmar contraseña', en: 'Confirm password' },
  'register.terms': { es: 'Acepto los términos y condiciones', en: 'I accept the terms and conditions' },
  ...
  'register.or': { es: 'O, Regístrate con', en: 'Or, Register with' },
  'register.google': { es: 'Registrarse con Google', en: 'Register with Google' },
